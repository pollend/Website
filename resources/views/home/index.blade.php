        ...
        <div class="col-lg-4 border-right">
            <div class="row">
                ...
                <div class="col-xs-7">
                    ...
                    <p>
                        <a class="btn btn-default v-margin" href="{{ route('assets.filter', ['mod']) }}" role="button" title="Mods">
                            View all {{ $assetCount->getModCount() }} Mods »
                        </a>
                    </p>
                </div>
            </div>
        ...
        <div class="col-lg-4 border-right">
            <div class="row">
                ...
                <div class="col-xs-7">
                    ...
                    <p>
                        <a class="btn btn-default v-margin" href="{{ route('assets.filter', ['blueprint']) }}" role="button" title="Blueprints">
                            View all {{ $assetCount->getBlueprintCount() }} Blueprints »
                        </a>
                    </p>
                </div>
            </div>
                ...
                <div class="col-xs-7">
                    ...
                    <p>
                        <a class="btn btn-default v-margin" href="{{ route('assets.filter', ['park']) }}" role="button" title="Parks">
                            View all {{ $assetCount->getParkCount() }} Parks »
                        </a>
                    </p>
                </div>
            </div>

...
class BlueprintExtractorStat extends \TestCase
{
    public function test_stats()
    {
        $blueprintExtractor = new BlueprintExtractor(base_path('tests/files/blueprint.png'));
        ...
        $this->assertEquals($expectedStats, $blueprintExtractor->getStats());
    }
}